...
*   **반응형 디자인:** 데스크톱, 태블릿, 모바일 등 모든 화면 크기에 맞춰 레이아웃과 폰트 크기가 자동으로 조절됩니다. 게임 캔버스 또한 화면 크기에 맞게 축소됩니다.
...
*   **낙하 네모:** 장애물을 피하는 플래피 버드 클론 게임입니다. (PC: 스페이스, **모바일: 터치로 점프**)
*   **너구리:** 동그라미 캐릭터가 삼각형 악당을 점프로 피하는 플랫포머 게임입니다. (PC: 스페이스, **모바일: 터치로 점프**)
*   **1984 (신규):** 1942 스타일의 비행기 슈팅 게임입니다. **자동으로 총알이 발사**되며, PC에서는 방향키로, **모바일에서는 터치 & 드래그로 기체를 조작**합니다.
